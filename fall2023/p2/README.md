...
**Assigned**: September 8th, 2023

**Due**: September 22nd, 2023, 11:59 PM

**Late Deadline**: September 25th, 11:59 PM
...
2. `pokemon_info(pokemon_name)` - Should show all info about the specified Pokemon. 
    ...
    identified by `pokemon_name`. The info includes the name, height, weight, base experience, moves, and abilities.
...
Some of these requirements are autograded in Gradescope to give you as much immediate feedback as possible.
In order for the autograder to work as expected, please only use features talked about in class and don't change the structure of the project.

*We reserve the right to change the autograder test cases at any time (e.g. to fix, add, or remove a test case) but the requirements listed below will not change.*
